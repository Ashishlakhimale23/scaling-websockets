...
export namespace Prisma {
  ...
  */
  ...
  export type RoomOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "RoomId" | "adminId" | "CreatedAt", ExtArgs["result"]["room"]>
  ...
  export type ChatsSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    room?: boolean | Chats$roomArgs<ExtArgs>
  ...
  export interface Prisma__ChatsClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    room<T extends Chats$roomArgs<ExtArgs> = {}>(args?: Subset<T, Chats$roomArgs<ExtArgs>>): Prisma__RoomClient<$Result.GetResult<Prisma.$RoomPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
   ...
   * Chats.room
   */
  export type Chats$roomArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Room
     */
    select?: RoomSelect<ExtArgs> | null
  ...
  export type ChatsWhereInput = {
    ...
    roomId?: IntNullableFilter<"Chats"> | number | null
  ...
  export type ChatsScalarWhereWithAggregatesInput = {
    ...
    roomId?: IntNullableWithAggregatesFilter<"Chats"> | number | null
  }
  ...
  export type ChatsUpdateInput = {
    ...
    room?: RoomUpdateOneWithoutChatsNestedInput
  }
